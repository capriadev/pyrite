...
#21 Disputes core - motor de disputas: matcher determinista (ventana dual, vinculo declarado, consumo unico), disputas faltante/tardio/no planificado con resolucion manual, worker y rebuild [spec: 019-disputes-core.md] [status: active]
#28 Disputes scoring - motor probabilistico: score sobre metadata e historico por task id, confianza por candidato, auto-link opt-in, consulta que envejece [spec: 020] [status: pending]
#29 Disputes intake - alta de task desde finances con payload preconfigurado y grupo de sistema finances/ con destino configurable [spec: 021] [status: pending]
