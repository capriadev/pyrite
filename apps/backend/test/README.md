...
- Los numeros de cobertura quedan en `docs/records/`: 34 aserciones del motor de recurrencia, 22
  del matcher de disputas, 31 del scorer, 19 de la retencion de logs, y 177 chequeos HTTP
  repartidos en los ocho humos (calendario 18, organizacion 17, fechas 15, pagos 11, disputas 38,
  scoring 25, intake 30, logs 23).
